...
const ExamList = () => {
  ...
  const badges = [
    ...
    { id: 4, name: "Speed Demon", icon: Zap, color: "bg-primary-500", earned: false }
  ]
      ...
      <div className="lg:ml-0" id="examlist-main-touch">
        ...
        <main className="p-6">
                  ...
                  <div key={exam.id || exam._id || idx} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${getDifficultyColor(exam.difficulty)}`}>{exam.difficulty} ⭐</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      ...
                      <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                        ...
                        Active from: {exam.startDate ? new Date(exam.startDate).toLocaleString() : 'Date not available'}
                      </div>
                      <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                      <div className="text-sm text-gray-500 dark:text-gray-400">{exam.category}</div>
                      {status === 'active' ? (
                        ...
                        <button className="flex items-center space-x-2 px-4 py-2 bg-gray-300 text-gray-500 rounded-lg cursor-not-allowed" disabled>
                          <Clock size={16} />
                          <span>{status === 'upcoming' ? 'Upcoming' : 'Unavailable'}</span>
                        </button>
                      )}
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 text-center hover:shadow-md transition-shadow">
              <div className="text-3xl font-bold text-primary-600 dark:text-primary-400 mb-2">{exams.length}</div>
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
          <div className="flex justify-around py-2">
            ...
            <Link to="/exams" className="flex flex-col items-center p-2 text-primary-600 dark:text-primary-400">
              <Clock size={20} />
